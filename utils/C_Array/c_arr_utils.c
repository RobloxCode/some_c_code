...
static void _arr_sort_helper(int *arr, int *tmp, const size_t left,
...
void arr_add(int *res, const size_t res_len, const int *arr1,
             const size_t arr1_len, const int *arr2, const size_t arr2_len) {
    if (!res || !arr1 || !arr2) {
        return;
    }
...
void arr_sub(int *res, const size_t res_len, const int *arr1,
             const size_t arr1_len, const int *arr2, const size_t arr2_len) {
    if (!res || !arr1 || !arr2) {
        return;
    }
...
void arr_mul(int *res, const size_t res_len, const int *arr1,
             const size_t arr1_len, const int *arr2, const size_t arr2_len) {
    if (!res || !arr1 || !arr2) {
        return;
    }
...
void arr_div(int *res, const size_t res_len, const int *arr1,
             const size_t arr1_len, const int *arr2, const size_t arr2_len) {
    if (!res || !arr1 || !arr2) {
        return;
    }
...
void arr_copy(int *dst, const size_t dst_len, const int *src,
